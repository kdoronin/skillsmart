 ...
 */
class WPM_Settings_Languages extends WPM_Settings_Page implements SettingsPage {
    ...
    {
        return $visitor->languagesPage($this);
    }
		...
		if ( $value = wpm_get_post_data_by_key( 'wpm_languages' ) ) {
			...
			foreach ( $value as $item ) {
				...
				$languages[ $code ] = array(
                    ...
                    'enable_frontend' => $item['enable_frontend'] ? 1 : 0,
					'locale'      => $item['locale'],
					'name'        => $item['name'],
